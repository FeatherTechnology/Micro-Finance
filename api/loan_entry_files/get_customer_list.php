...
if ($customer_mapping == 1) {
    ...
    $query = "SELECT cc.id, cc.cus_id, cc.first_name, cc.last_name, cc.mobile1, anc.areaname 
              ...
              LEFT JOIN area_name_creation anc ON cc.area = anc.id
              WHERE lelc.loan_status IN (8,9) AND cc.customer_status !=2";
    ...
    $query = "SELECT cc.id, cc.cus_id, cc.first_name, cc.last_name, cc.mobile1, anc.areaname 
              ...
              LEFT JOIN area_name_creation anc ON cc.area = anc.id WHERE cc.multiple_loan = 1 AND cc.customer_status !=2 group by cc.id";
}
