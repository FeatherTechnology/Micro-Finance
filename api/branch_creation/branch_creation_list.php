...
$query = "SELECT bc.id, bc.branch_code,  bc.branch_name, bc.place, st.state_name, dt.district_name, bc.mobile_number   FROM branch_creation bc LEFT JOIN States st ON bc.state = st.id LEFT JOIN districts dt ON bc.district = dt.id LEFT JOIN taluks tk ON bc.taluk = tk.id WHERE 1 ";
