...
$qry = $pdo->query("SELECT `id`,`scheme_name`, `due_method`, `benefit_method`, `interest_rate_percent_min`, `due_period_percent_min`, `doc_charge_min`, `doc_charge_max`, `processing_fee_min`, `processing_fee_max`,`scheme_status` FROM `scheme` ");
if ($qry->rowCount() > 0) {
