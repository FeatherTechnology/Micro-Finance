$(document).ready(function () {
  $("#branch_id").change(function () {
    ...
    getLoanIssueCounts(branch_id);
    getCollectionCounts(branch_id);
    getClosedCounts(branch_id);
}, 500);
  });
...
function checkUserScreenAccess() {
  $.post(
    "api/common_files/check_user_screen_access.php",
    {},
    function (response) {
...
function getBranchList() {
  $.post(
    "api/dashboard_files/get_branch_list.php",
    function (response) {
...
function getLoanEntryCounts(branch_id) {
  $.post(
    "api/dashboard_files/loan_entry_details.php",
    { branch_id },
    function (response) {
...
function getApprovalCounts(branch_id) {
  $.post(
    "api/dashboard_files/approval_details.php",
    { branch_id },
    function (response) {
...
function getLoanIssueCounts(branch_id) {
  $.post(
    "api/dashboard_files/loan_issue_details.php",
    { branch_id },
    function (response) {
...
function getCollectionCounts(branch_id) {
  $.post(
    "api/dashboard_files/collection_details.php",
    { branch_id },
    function (response) {
...
function getClosedCounts(branch_id) {
  $.post(
    "api/dashboard_files/closed_details.php",
    { branch_id },
    function (response) {
...
function callCollectionChart() {
  let branch_id = $("#branch_hidden_id").val();
  $.ajax({
    type: "POST",
    data: { branch_id },
...
function getPaidDetails(
  ...
  var chart = new google.visualization.PieChart(
    document.getElementById("collection_paid")
  );
...
function getOdDetails(
  ...
  var chart = new google.visualization.PieChart(
    document.getElementById("collection_od")
  );
  chart.draw(data, Options);
}
