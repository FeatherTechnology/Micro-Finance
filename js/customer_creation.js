$(document).ready(function () {
  ...
  $(document).on("click", ".customerDeleteBtn", function () {
    ...
    swalConfirm(
      "Delete",
      "Do you want to Delete the Customer Details?",
      getCustomerDelete,
      id
    );
    return;
...
//     }
//     else{
//         swalError('Warning', 'Error occur while Delete KYC.');
//     }
//     },
//     "json"
//   );
...
function getCustomerEntryTable() {
  serverSideTable(
    "#customer_create",
    "",
    "api/customer_creation_files/customer_creation_list.php"
  );
  // setDropdownScripts();
}
...
function getAutoGenCusId(id) {
  $.post(
    "api/customer_creation_files/get_autoGen_cus_id.php",
    { id },
    function (response) {
      $("#cus_id").val(response);
    },
...
function editCustomerCreation(id) {
  $.post(
    "api/customer_creation_files/customer_creation_data.php",
    { id: id },
    function (response) {
      $("#customer_profile_id").val(id);
